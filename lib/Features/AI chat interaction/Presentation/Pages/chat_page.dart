...
class ChatPage extends StatefulWidget {
  ...
  ChatPage({super.key, required this.conversationID, required this.initialQuery});
...
class _ChatPageState extends State<ChatPage> {
  ...
  void initState() {
    ...
    Future.delayed(Duration(milliseconds: 100), () => _sendMessage(isFirstMessage: true));
  }
  }
          ...
          children: [
            ...
            Expanded(
              child:StreamBuilder<List<Map<String, dynamic>>>(
                ...
                itemCount: snapshot.data!.length + (_isAwaitingResponse ? 1 : 0),
                itemBuilder: (context, index) {
                  if (index == snapshot.data!.length && _isAwaitingResponse) {
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: _buildIconContainer(Icons.insert_photo_outlined),
                        suffixIcon: GestureDetector(
                          onTap: () => bottomsheet(context),
                          child: const Icon(Icons.graphic_eq, size: 25, color: Colors.black54),
                        ),
...
//// TODO: it can be done without adding packages
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: 10),
          LoadingAnimationWidget.waveDots(color: Colors.grey, size: 50), // 🔹 Wave Dots Loader
        ],
      ),
    );
  }
    ...
    GestureDetector(
      onTap: () {
        if(_searchController.text.trim().isNotEmpty){
          ...
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Please Enter text first",
