...
class PlantData {
  ...
  factory PlantData.fromJson(Map<String, dynamic> json) {
    return PlantData(
      plantIdentification: PlantIdentification.fromJson(json['plant_identification']),
...
class HealthAssessment {
  ...
  HealthAssessment({required this.overallHealth, required this.potentialIssues});
...
class HealthIssue {
  ...
  factory HealthIssue.fromJson(Map<String, dynamic> json) {
    return HealthIssue(issue: json['issue'], remedy: json['remedy']);
  }
}
...
class GrowingConditions {
  ...
  GrowingConditions({required this.sunlight, required this.watering, required this.soilType});
...
class CommonProblems{
    ...
    factory CommonProblems.fromJson(Map<String, dynamic> json){
        return CommonProblems(problems:  (json['problems'] as List)
