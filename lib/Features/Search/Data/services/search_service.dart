...
//     if (box.isNotEmpty) {
//       print("Fetching plants from Hive..");
...
//         }
//       } else {
//         print("Failed to load crops: ${response.reasonPhrase}");
//         return [];
//       }
//     } catch (e) {
...
class SearchService {
  ...
  static Future<List<PlantInfo>> fetchPlants(
    ...
    print("Fetching all plants from API...");
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonData.containsKey('crops')) {
          List<PlantInfo> plants = (jsonData['crops'] as List)
            ...
            print("Printing All Plants from $plants");
