...
// Controllers for input fields
  ...
  void selectCrop(Map crop) {
    ...
    print("API Response for Selected Crop: ${jsonEncode(crop)}");
    ...
    if (crop['fertilizerCalculation']?['stages'] != null &&
      ...
      stages.clear();
      print("Error: No stages found for this crop.");
    }
  ...
  void selectStage(Map stage) {
    ...
    if (stage['fertilizerQuantity']?['NPK'] != null) {
      ...
      print("Extracted NPK Values: $npk"); // Debugging
      ...
      print("Error: No NPK data found in the selected stage.");
  ...
  void calculateFertilizer1() {
    ...
    print("🔹 Selected Area Unit: ${selectedAreaUnit.value}");
    print("🔹 Area Factor: $areaFactor");
    print("🔹 Plot Size: ${plotSize.value}");
    print("🔹 Area Value: ${areaValue.value}");
    print("🔹 Soil pH: ${soilPH.value}");
    print("🔹 pH Adjustment Factor: $phAdjustmentFactor");
    ...
    print(" Fertilizer Calculations:");
    print("🔹 Urea: ${urea.value}, TSP: ${tsp.value}, MOP: ${mop.value}");
