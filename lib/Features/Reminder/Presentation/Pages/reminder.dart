                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          DateFormat('E').format(date), // Display day (e.g., Mon)
                          style: TextStyle(
                        ...
                        Text(
                          DateFormat('d').format(date), // Display date (e.g., 5)
                          style: TextStyle(
                            fontSize: 18,
                            fontWeight: FontWeight.bold,
                            color: _selectedDate.day == date.day
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text("ADD EVENT",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15 ),)
                  ],
                ),
              ),
            ),
